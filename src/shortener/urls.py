...
urlpatterns = [
    ...
    url(
        ...
        auth_views.PasswordChangeView.as_view(
            template_name='shortener/auth/password_change_form.html',
            success_url=reverse_lazy('shortener:password_change_done')
        ),
    ...
    url(
        ...
        auth_views.PasswordChangeDoneView.as_view(
            template_name='shortener/auth/password_change_done.html'
        ),
